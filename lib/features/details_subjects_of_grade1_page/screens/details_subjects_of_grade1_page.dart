...
class DetailsSubjectOfGrade1 extends StatefulWidget {
  ItemsGrade1 itemsGrade1 ;
  DetailsSubjectOfGrade1({super.key, required this.itemsGrade1});
  @override
  State<DetailsSubjectOfGrade1> createState() => _DetailsSubjectOfGrade1State();
}

class _DetailsSubjectOfGrade1State extends State<DetailsSubjectOfGrade1> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  widget.itemsGrade1.subjectName,
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            if (isGoin == false) {
                              cart.addItemsGrade1(
                                  ItemsGrade1(
                                      subjectName: widget.itemsGrade1.subjectName,
                                      doctorName: widget.itemsGrade1.doctorName));
                            }
                            else if(isGoin == true){
                              cart.deleteItemsGrade1(ItemsGrade1(
                                  subjectName: widget.itemsGrade1.subjectName,
                                  doctorName: widget.itemsGrade1.doctorName));
                            }
