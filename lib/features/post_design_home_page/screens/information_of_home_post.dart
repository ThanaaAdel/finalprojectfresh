...
class InformationOfHomePost extends StatefulWidget {
  final dataFromDB;

  const InformationOfHomePost({Key? key, required this.dataFromDB}) : super(key: key);

  @override
  State<InformationOfHomePost> createState() => _InformationOfHomePostState();
}

class _InformationOfHomePostState extends State<InformationOfHomePost> {
