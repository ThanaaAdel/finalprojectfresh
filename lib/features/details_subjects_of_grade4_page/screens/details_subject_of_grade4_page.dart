...
class DetailsSubjectOfGrade4 extends StatefulWidget {
  ItemsGrade4 itemsGrade4 ;
  DetailsSubjectOfGrade4({super.key, required this.itemsGrade4});
  @override
  State<DetailsSubjectOfGrade4> createState() => _DetailsSubjectOfGrade4State();
}

class _DetailsSubjectOfGrade4State extends State<DetailsSubjectOfGrade4> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  widget.itemsGrade4.subjectName,
                    ...
                    TextButton(
                        onPressed: () {
                          setState(() {
                            isGoin = !isGoin;
                            if (isGoin == false) {
                              carttt.addItemsGrade4(
                                  ItemsGrade4(
                                      subjectName: widget.itemsGrade4.subjectName,
                                      doctorName: widget.itemsGrade4.doctorName));
                            }
                            else if(isGoin == true){
                              carttt.deleteItemsGrade4(ItemsGrade4(
                                  subjectName: widget.itemsGrade4.subjectName,
                                  doctorName: widget.itemsGrade4.doctorName));
                            }
