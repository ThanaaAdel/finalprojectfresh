...
class AddPostGroup extends StatefulWidget {
  const AddPostGroup({Key? key}) : super(key: key);

  @override
  State<AddPostGroup> createState() => _AddPostState();
}

class _AddPostState extends State<AddPostGroup> {
        ...
        actions: [
          TextButton(
              onPressed: () async{
                ...
                await FirestoreMethods().uploadgroupPost(
                    imgName: imgName,
                    imgPath: imgPath,
