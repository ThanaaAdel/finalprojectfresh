...
class InformationOfEventPost extends StatefulWidget {
  final dataFromDB;

  const InformationOfEventPost({Key? key, required this.dataFromDB}) : super(key: key);

  @override
  State<InformationOfEventPost> createState() => _InformationOfEventPostState();
}

class _InformationOfEventPostState extends State<InformationOfEventPost> {
