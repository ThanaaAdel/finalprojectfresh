...
const appbarbluegray =Colors.blueGrey;
const Color kTextColor = Color(0xff7a7a7a);
const Color kSecondaryColor = Color.fromARGB(255, 218, 216, 216);
//zoom
const Color primaryColorCamera = Color.fromRGBO(5, 10, 14, 1);
const Color secondaryColorCamera = Color.fromRGBO(43, 48, 52, 1);
